            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {contactInfo.map((item, index) => (
                  <div key={index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-200 border">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-red-100 to-gray-100 rounded-full flex items-center justify-center">
              ...
              {/* Social Media */}
              <div className="bg-gradient-to-br from-gray-900 to-red-900 rounded-2xl p-8 text-white">
